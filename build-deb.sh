...
Section: text
Priority: optional
Depends: python3 (>= 3.11), python3-gi, gir1.2-gtk-3.0, gir1.2-gdkpixbuf-2.0
X-Typix-Compatible-OS: raspios-bookworm,raspios-trixie
Description: Local-first TypixDeck reader
 Native GTK3 reader for local TXT, Markdown, EPUB, and CBZ files.
 Documents are parsed on-device; no browser engine or analytics is used.
CONTROL
